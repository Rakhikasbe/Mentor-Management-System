         ...
         <div class="row">
	         ...
	         <tr>
				...
				<td>
					...
					<a href="changeStudentMeetStatusDB.jsp?id=<%=rs.getString("studMeetingId") %>&&status=<%=rs.getString("status") %>" class="btn btn-info btn-sm"><%=rs.getString("status") %></a>
					<%}else{ %>
					<a href="changeStudentMeetStatusDB.jsp?id=<%=rs.getString("studMeetingId") %>&&status=<%=rs.getString("status") %>" class="btn btn-danger btn-sm"><%=rs.getString("status") %></a>
					<%} %>
				</td>
				</tr>
				<% i++;}
