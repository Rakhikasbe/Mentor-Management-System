...
// try {
    ...
    String meetingDate = request.getParameter("meetingDate");
	 ...
	 String sql = "insert into studentmeeting(meetingTitle, meetingDate, meetingTime, meetingDuration, platform, platformLink, branch, notes, status, mentorId)values(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
	 ...
	 ps.setString(10, session.getAttribute("mentorId").toString());
