<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
 ...
 try {
	 ...
	 String sql = "insert into studentfeedback(feedbackType, message, feedbackDate, mentorId, studentId)values(?, ?, ?, ?, ?)";
	 PreparedStatement ps = con.prepareStatement(sql);
	 ps.setString(1, feedbackType);
	 ps.setString(2, message);
	 ps.setString(3, feedbackDate);
	 ps.setString(4, session.getAttribute("mentorIDD").toString());
	 ps.setString(5, session.getAttribute("studId").toString());
